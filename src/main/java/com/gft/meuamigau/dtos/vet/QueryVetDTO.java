...
import static com.gft.meuamigau.enums.constants.OpenApiAnnotations.SCHEMA_VET_USERNAME_DESCRIPTION;
import static com.gft.meuamigau.enums.constants.OpenApiAnnotations.SCHEMA_VET_USERNAME_EXAMPLE;
import static com.gft.meuamigau.enums.constants.OpenApiAnnotations.SCHEMA_VET_USERNAME_TITLE;
...
public class QueryVetDTO {
	...
	@Schema(type = SCHEMA_TYPE_STRING
			, title = SCHEMA_VET_USERNAME_TITLE
			, description = SCHEMA_VET_USERNAME_DESCRIPTION
			, example = SCHEMA_VET_USERNAME_EXAMPLE)
